...
func Test_tokenSection_WithVariableName_Success(t *testing.T) {
	grammarFile := "./grammar/grammar.json"
	pars := createParserForTests("tokenSection", grammarFile)

	file := "./tests/codes/tokensection/variablename.rod"
	...
	if !code.IsVariableName() {
		t.Errorf("the TokenSection was expected to contain a VariableName instance")
		return
	}
